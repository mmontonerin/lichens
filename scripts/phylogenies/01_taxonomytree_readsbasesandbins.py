...
OUT_PNG = f"{OUT_DIR}/lichens_tree_reads-bases_bins.png"
OUT_PDF = f"{OUT_DIR}/lichens_tree_reads-bases_bins.pdf"
...
def layout(node):
    ...
    if vals:
        ...
        # empty spacers so columns stay aligned
    ...
    # bins panel
    if key:
        faces.add_face_to_node(_bins_img_face(key), node, column=6, position="aligned")
