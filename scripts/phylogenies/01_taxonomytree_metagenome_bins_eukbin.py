...
BINS_CSV   = "/lustre/scratch127/tol/teams/blaxter/users/mn16/lichens/results/metagenome_tables/bins_filtered_eukbin.csv"
OUT_PNG    = "lichens_tree_bins_eukbin_euk.png"
OUT_PDF    = "lichens_tree_bins_eukbin_euk.pdf"

# --- Load data ---
ncbi = NCBITaxa(TAXDB)
df_bins = pd.read_csv(BINS_CSV)

df_bins = df_bins[df_bins["phylum"] != "cyanobacteriota"]
