...
BINS_CSV   = "/lustre/scratch127/tol/teams/blaxter/users/mn16/lichens/results/metagenome_tables/bins_filtered_remag.csv"
OUT_PNG    = "lichens_tree_bins_remag_euk.png"
OUT_PDF    = "lichens_tree_bins_remag_euk.pdf"
