...
OUT_PNG = f"{OUT_DIR}/lichens_tree_reads-bases_bins_kraken_div.png"
OUT_PDF = f"{OUT_DIR}/lichens_tree_reads-bases_bins_kraken_div.pdf"
...
mito_div     = load_diversity(MITO_CSV)
plastid_div  = load_diversity(PLASTID_CSV)
bacteria_div = load_diversity(BACTERIA_CSV)
