#!/bin/bash
#BSUB -o ./log/lepidoptera-hifiasm-%J-%I-output.log
#BSUB -e ./log/lepidoptera-hifiasm-%J-%I-error.log 
#BSUB -J hifiasm[1-38]
#BSUB -q long
#BSUB -G team301
#BSUB -n 32
#BSUB -M 60000
#BSUB -R "select[mem>60000] rusage[mem=60000]"
#BSUB -W 48:00
...
path_config="/lustre/scratch127/tol/teams/blaxter/users/mn16/lichens/scripts/genome_assembly/01_array_config_lepidoptera.txt"
