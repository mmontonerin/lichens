#!/bin/bash
#BSUB -o ./log/cyanobacteriota-hifiasm-mem-%J-%I-output.log
#BSUB -e ./log/cyanobacteriota-hifiasm-mem-%J-%I-error.log 
#BSUB -J hifiasm[17,20]
#BSUB -q long
#BSUB -G team301
#BSUB -n 32
#BSUB -M 250000
...
path_config="/lustre/scratch127/tol/teams/blaxter/users/mn16/lichens/scripts/genome_assembly/01_array_config_cyanobacteriota.txt"
