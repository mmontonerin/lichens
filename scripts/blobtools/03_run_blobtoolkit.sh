...
nextflow run /nfs/treeoflife-01/teams/tola/users/yy5/btk_current/blobtoolkit/main.nf \
    ...
    --taxdump /nfs/users/nfs_m/mn16/db/ncbi_taxonomy/latest/new_taxdump \
    --busco /nfs/users/nfs_m/mn16/db/busco/latest \
    --blastp /nfs/users/nfs_m/mn16/db/uniprot_reference_proteomes/latest/reference_proteomes.dmnd \
