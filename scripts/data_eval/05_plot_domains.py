...
input_csv = "/lustre/scratch127/tol/teams/blaxter/users/mn16/lichens/results/kraken2/00_csv-rank_reports_includeparents_reads/domain_all_combined_filtered.csv"
...
# === Export ===
png_path = os.path.join(output_dir, "domain_boxplot.png")
pdf_path = os.path.join(output_dir, "domain_boxplot.pdf")
