#!/bin/bash
#BSUB -o ./log/sponge_kraken-%J-output.log
#BSUB -e ./log/sponge_kraken-%J-error.log 
#BSUB -J kraken2_nt
#BSUB -q hugemem
#BSUB -G team301
#BSUB -n 10
...
data_dir="/lustre/scratch127/tol/teams/blaxter/users/mn16/lichens/data/sponges_test"
database="/nfs/users/nfs_m/mn16/db/nt_kraken2/latest"
#database="/nfs/users/nfs_m/mn16/db/refseq_kraken2/latest"
output_dir="/lustre/scratch127/tol/teams/blaxter/users/mn16/lichens/results/kraken2/sponges"
...
do
    ...
    for dataset in ${lichen}/genomic_data/o*
    do
        [ -d ${dataset} ] || continue
