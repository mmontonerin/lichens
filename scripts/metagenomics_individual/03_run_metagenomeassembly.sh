...
#BSUB -J metagenomeassembly[1-39]
...
launch_base="/lustre/scratch127/tol/teams/blaxter/users/mn16/lichens/scripts/metagenomics_individual/launch/${LSB_JOBID}_${LSB_JOBINDEX}"
mkdir -p ${launch_base}
cd ${launch_base}
work_dir="/lustre/scratch127/tol/teams/blaxter/users/mn16/lichens/scripts/metagenomics_individual/log/${LSB_JOBID}_${LSB_JOBINDEX}"
