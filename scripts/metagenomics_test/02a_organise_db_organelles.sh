...
# Additional files
# NCBI taxonomy:
wget -O db/prot.accession2taxid.FULL.gz https://ftp.ncbi.nlm.nih.gov/pub/taxonomy/accession2taxid/prot.accession2taxid.FULL.gz

# NCBI taxon names and taxon nodes:
wget -O db/taxdmp.zip https://ftp.ncbi.nlm.nih.gov/pub/taxonomy/taxdmp.zip
