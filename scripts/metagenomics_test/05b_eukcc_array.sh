#!/bin/bash
#BSUB -o ./log/eukcc_remag-%J-%I-output.log
#BSUB -e ./log/eukcc_remag-%J-%I-error.log 
#BSUB -J eukcc[1-38]
#BSUB -q long
#BSUB -G team301
#BSUB -n 8
...
output_dir=${sp}/bins/taxonomy_eukcc_remag
mkdir -p ${output_dir}

eukcc folder --out ${output_dir} --threads 8 ${sp}/bins/fasta/remag/bins