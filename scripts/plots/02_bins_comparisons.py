...
method_labels = {
    "metabat2": "metabat2",
    "eukcc":    "metabat2+eukcc / eukbin+eukcc",   # coarse label; split below if needed
    "dastool":  "metabat2+dastool",
    "eukbin":   "eukbin",
}

# Finer label: distinguish eukcc origin by source table
df1["method_label"] = df1["binning_method"].map(
    {"metabat2": "metabat2", "eukcc": "metabat2+eukcc", "dastool": "metabat2+dastool"}
)
df2["method_label"] = df2["binning_method"].map(
    {"eukbin": "eukbin", "eukcc": "eukbin+eukcc", "dastool": "metabat2+dastool"}
)
...
method_order = ["metabat2", "metabat2+eukcc", "eukbin", "eukbin+eukcc", "metabat2+dastool"]
...
# === Export ===
png_path1 = os.path.join(output_dir, "plot1_completeness_violin.png")
pdf_path1 = os.path.join(output_dir, "plot1_completeness_violin.pdf")

fig1.savefig(pdf_path1, bbox_inches="tight", dpi=800)
fig1.savefig(png_path1, bbox_inches="tight", dpi=800)
print("Saved plot1_completeness_violin.pdf / .png")
...
fig2.tight_layout()
# === Export ===
png_path2 = os.path.join(output_dir, "plot2_nbins_violin.png")
pdf_path2 = os.path.join(output_dir, "plot2_nbins_violin.pdf")

fig2.savefig(pdf_path2, bbox_inches="tight", dpi=800)
fig2.savefig(png_path2, bbox_inches="tight", dpi=800)
print("Saved plot2_nbins_violin.pdf / .png")